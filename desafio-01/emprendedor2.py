...
numero_usuarios_normales = input_number("Ingrese la cantidad de usuarios normales: ", int)
numero_usuarios_premium = input_number("Ingrese la cantidad de usuarios premium: ", int)
